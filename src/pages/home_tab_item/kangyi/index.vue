...
export default class extends Vue {
  ...
  public kangyiNewsList: any[] = [];
  public kangyiSwiperList: any[] = [];
  public kangyiSecondnavList: any[] = [];
  // 下拉刷新，上拉加载的数据
  ...
  public handlerClickKangyiSecondnavList(item: any, index: number) {
